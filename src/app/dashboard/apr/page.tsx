  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <ShieldCheck size={44} style={{ color: '#660099' }} />
      </div>
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{
          ...
          Este módulo está em desenvolvimento. Em breve você poderá gerenciar e registrar
          Análises Preliminares de Risco diretamente por aqui.
        </p>
      </div>
