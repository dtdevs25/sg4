      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl flex flex-col justify-between">
          <div className="flex justify-between items-start">
            <span className="text-slate-400 text-xs font-bold uppercase tracking-wider">Atingimento do Mês</span>
                  ...
                  <tr key={t.id} className="hover:bg-slate-950/20 transition-colors text-sm">
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <span className="font-semibold text-white block">{t.nome}</span>
                    ...
                    <td className="py-4 px-6 text-center">
                      {editingId === t.id ? (
                        <input
                          ...
                          className="w-16 px-2 py-1 rounded bg-slate-950 border border-slate-700 text-center text-white focus:outline-none focus:border-red-500 font-semibold"
                        />
                      ) : (
                      ...
                      {editingId === t.id ? (
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          <button
                            ...
                            className="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-bold transition-colors"
                          >
                            Cancelar
                          </button>
                        </div>
                        ...
                        <button
                          ...
                          className="text-slate-400 hover:text-white hover:bg-slate-850 px-3 py-1.5 rounded-lg border border-slate-800 hover:border-slate-700 text-xs font-semibold transition-all"
                        >
                          Lançar Realizado
                        </button>
                      )}
