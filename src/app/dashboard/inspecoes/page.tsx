    ...
    if (tecRes.success && tecRes.data) {
      ...
      const newData = tecnicos.map((t: any) => {
        const tecArkium = arkiumList.filter((a: any) => {
          ...
          const nomePlanilha = normalize(a.nomeAuditor)
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center' }}>
              <h3 style={{ margin: '0 0 6px 0', fontSize: 18, fontWeight: 800, color: '#1e293b' }}>{importResult ? 'Importação Concluída!' : 'Importando Inspeções'}</h3>
            ...
            <div style={{ background: '#fff', borderRadius: 16, width: '100%', maxWidth: 700, display: 'flex', flexDirection: 'column', maxHeight: '90vh', overflow: 'hidden' }}>
              ...
              <div style={{ background: '#660099', padding: '20px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <div>
                    ...
                    <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.7)', fontWeight: 600 }}>Inspeções por mês em {selectedYear === 'ALL' ? 'Todos os Anos' : selectedYear}</span>
                  </div>
                </div>
              ...
              <div style={{ padding: 24, overflowY: 'auto' }}>
                ...
                <div style={{ display: 'flex', gap: 16, justifyContent: 'center', fontSize: 11, color: '#64748b', fontWeight: 600, flexWrap: 'wrap' }}>
                  <span style={{ display: 'flex', alignItems: 'center', gap: 6 }}><span style={{ width: 12, height: 12, borderRadius: 2, background: '#660099', display: 'inline-block' }} />Realizadas</span>
                </div>
