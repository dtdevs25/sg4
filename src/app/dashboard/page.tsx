...
// Evolução acumulada para o area chart
...
export default function DashboardPage() {
  ...
  // KPI values — se mês selecionado, mostra do mês; senão acumulado
  ...
  const radialData = [
    ...
    { name: 'Inspeção', value: pctInsp, fill: '#f97316' },
    ...
    <div className="space-y-8 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-5">
        <div>
          ...
          <p className="text-slate-400 text-xs mt-0.5">Indicadores operacionais · TST SG4 · 2026</p>
        </div>
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          {mesSel && (
            <span className="ml-1 text-xs text-slate-400 font-medium">
              — exibindo dados de <span className="text-red-600 font-bold">{mesSel}/2026</span>
            </span>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        />
        <KpiCard
          label="Inspeções" value={kpiInsp.toLocaleString('pt-BR')}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 bg-white border border-slate-100 rounded-3xl p-7 shadow-sm">
          <div className="flex items-center gap-2 mb-6">
            ...
            <div>
              <h2 className="text-sm font-bold text-slate-800">Evolução Mensal 2026</h2>
          ...
          <ResponsiveContainer width="100%" height={300}>
            <AreaChart data={areaData} margin={{ left: -10, right: 10, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="insp"     name="Inspeção" stroke="#f97316" strokeWidth={2.5} fill="url(#inspGrad)" dot={{ r: 4, strokeWidth: 2, fill: '#fff', stroke: '#f97316' }} activeDot={{ r: 6 }} />
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 bg-white border border-slate-100 rounded-3xl p-7 shadow-sm">
          <div className="flex items-center gap-2 mb-6">
            ...
            <div>
              <h2 className="text-sm font-bold text-slate-800">Desempenho por Técnico</h2>
          ...
          <ResponsiveContainer width="100%" height={320}>
            <BarChart data={barData} margin={{ left: -15, right: 10, bottom: 10 }} barCategoryGap="30%">
              ...
              <Bar dataKey="insp" name="Inspeção" fill="#f97316" radius={[6, 6, 0, 0]} maxBarSize={20} />
            </BarChart>
          </ResponsiveContainer>
        </div>
